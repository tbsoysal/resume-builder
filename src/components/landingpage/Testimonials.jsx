    ...
    <section className="testimonials">
      <div>
        ...
        <div className="controlls">
          <a onClick={() => setTranslateX(translateX + 633)} className={`${translateX >= 0 ? "passive" : ""}`} ><svg className={`${translateX >= 0 ? "passive" : ""}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 64 64" aria-label="Arrow Left"><path fill="currentColor" fillRule="evenodd" d="M8.145 32.552L31.772 9.925l3.771 3.771-16.19 16.19h33.942v5.333H19.353l16.19 16.19-3.771 3.77L9.145 32.553z" clipRule="evenodd"></path></svg></a>
          <a onClick={() => setTranslateX(translateX - 633)} className={`${translateX <= maxScroll ? "passive" : ""}`}><svg className={`${translateX <= maxScroll ? "passive" : ""}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 64 64" ><path fill="currentColor" fillRule="evenodd" d="M54.853 31.449L32.227 54.076l-3.771-3.771 16.19-16.19H10.702v-5.333h33.942l-16.19-16.19 3.771-3.77 22.627 22.627z" clipRule="evenodd"></path></svg></a>
        </div>
      </div>
      <ul ref={carouselRef} style={{ transform: `translateX(${Math.max(translateX, maxScroll)}px)` }}>
        <li>
