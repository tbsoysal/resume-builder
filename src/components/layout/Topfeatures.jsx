    ...
    <section className={styles.topfeatures}>
      <ul>
        <li>
          ...
          <p>İlk özgeçmişiniz,<br className={styles.breakElement} /> ömür boyu ücretsiz</p>
        </li>
        <li>
          ...
          <p>Gizlilik &<br className={styles.breakElement} /> GDPR uyumlu</p>
        </li>
        <li>
          ...
          <p>Profesyonel<br className={styles.breakElement} /> tasarımlı şablonlar</p>
        </li>
      </ul>
    </section>
  )
