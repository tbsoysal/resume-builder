...
import { CategoryName, CategoryTypes, CvDataType, SkillType } from "../CvData";

interface SkillsFormProps {
  skillInput: SkillType;
  setSkillInput: React.Dispatch<React.SetStateAction<SkillType>>;
  addItem: (categoryName: CategoryName, newItemObject: SkillType, resetInput: () => void) => void;
